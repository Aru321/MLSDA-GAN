...
if __name__ == '__main__':
    train_txt_path = r"E:\Projects\PyCharm Projects\CVT3D\dataset\split\Ex2\train.txt"
    val_txt_path = r"E:\Projects\PyCharm Projects\CVT3D\dataset\split\Ex2\val.txt"
    train_imgs = readTxtLineAsList(train_txt_path)
    print(train_imgs)
    val_imgs = readTxtLineAsList(val_txt_path)
    print(val_imgs)
    trainloader=loadData('E:\Projects\PyCharm Projects\CVT3D\dataset\clinical/train_l_cut','','E:\Projects\PyCharm Projects\CVT3D\dataset\clinical/train_s_cut','',prefixs=train_imgs,batch_size=1)
    print("=================================")
    valloader = loadData('E:\Projects\PyCharm Projects\CVT3D\dataset\clinical/train_l_cut', '',
                           'E:\Projects\PyCharm Projects\CVT3D\dataset\clinical/train_s_cut', '', prefixs=val_imgs,
                           batch_size=1)